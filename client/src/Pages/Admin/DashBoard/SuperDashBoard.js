...
import { totalCA,produitMarche,venteBLProduit,venteBLPharmacie,chartPharmacieBricks,chiffreParIms,
          suiviMensuel,chiffreParSecteur,venteBLParDelegue, getDeleguePharmacie  } from "../../../Redux/dashReduce";
...
function SuperDashBoard() {
  ...
  React.useEffect(() => {
    ...
    getBLParDelegue,getBricks,getIms,getSecteur,getSecteurActiveBL,getSuivi,getUtilisateur,idLine,idRole,anneeLocal]);
