...
function ListMarcheIms() {
  document.title = "Liste des marchés";
  ...
  function changeEtat(id,e) {
    dispatch(marcheChangerEtat( id )).then(e1=>{
      getMarche();
      switch(e){
        case 0: notify("tr", "Marché activer avec succes", "success");break; 
        case 1:notify("tr", "Marché désactiver avec succes", "success");break;
        default:break;
      }  
    }); 
  }
    ...
    <>
      <Container fluid>
        ...
        <Row>
          ...
          <Col md="12">
            <h4 className="title">Liste des marchés</h4>
            <Card>
              <Card.Body>
                <ReactTable
                  data={entities}
