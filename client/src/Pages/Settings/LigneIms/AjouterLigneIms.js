...
function AjouterLigneIms() {
  ...
  if (isNaN(location.id) === true) document.title = "Ajouter un ligne ims";
  else  document.title = "Modifier le ligne ims";
  ...
  function submitForm(event) {
    if(nom === "")      
      notify("tr", "Ligne Ims est obligatoire", "danger");
    else {
                ...
                <Form action="" className="form" method="">
                  <Card>
                    <Card.Header>
                      <Card.Header>
                        <Card.Title as="h4">
                          { typeof location.id == "undefined" ? "Ajouter ligne Ims" : "Modifier ligne Ims" }
                        </Card.Title>
                      </Card.Header>
                    </Card.Header>
                    <Card.Body>
